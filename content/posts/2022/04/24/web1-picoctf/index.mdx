...
slug: "picoctf-2022/2022-04-24-web-beginner"
tags: ["picoctf", "ctf", "web-security", "writeup"]
---
...
![Cookie](/media/content/posts/2022/04/24/web1-picoctf/cookie.png)
...
![Roboto](/media/content/posts/2022/04/24/web1-picoctf/roboto.png)
...
When scouting the directory of [http://saturn.picoctf.net:49917/secret/](http://saturn.picoctf.net:49917/secret/), we see an image file and another folder called hidden.

When scouting the directory of [http://saturn.picoctf.net:49917/secret/hidden/](http://saturn.picoctf.net:49917/secret/hidden/), we see a login page and a folder called superhidden.
