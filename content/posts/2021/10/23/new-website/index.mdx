...
The source code for this site is available on [GitHub](https://github.com/ZyphenSVC/zyphensvc.github.io)
...
Make sure to follow my [Twitter](https://twitter.com/ZyphenSVC) for announcements. You can friend me on Discord with [Zyphen#8624](https://discord.com/users/328580491290607616). Additionally, you can add my [RSS feed](https://zyphensvc.github.io/rss.xml) to your favourite reader app. Hope you enjoy!