                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-10 col-xl-8">
                                ...
                                <div className="main-fade-in-animation">
                                    <p>You can send an email to <code class="language-text">sriaditya dot vedantam at gmail dot com</code>.</p>
                                    <p>Here is my <a aria-label="PGP key" href="/Zyphen.pgp">PGP key</a> if you wish to communicate using encryption.</p>
