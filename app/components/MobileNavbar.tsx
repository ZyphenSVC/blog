...
export function MobileNavbar() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <aside className="fixed right-0 top-0 z-[100] h-screen w-[min(20rem,calc(100vw-2rem))] max-w-full border-l border-[#575253] bg-[#2F2D2E] px-8 py-8 shadow-2xl lg:hidden">
